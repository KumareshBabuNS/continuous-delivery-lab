...
. Under +Build+, add a +Execute Shell+ build step. Copy and paste the following script into the "Command" textarea. 
You will need to replace the placeholders for << Your PWS Username >>, 
